...
public class WaiterController {
    ...
    public String showOrderInWaiter (@PathVariable("orderId") String orderId, Model uiModel, Locale locale) {
        ...
        uiModel.addAttribute("message", new Message("info", messageSource.getMessage("label_order_content", new Object[]{}, locale) + ": " + orderContent));
    ...
    public String showBillInWaiter (@PathVariable("billId") String billId, Model uiModel, Locale locale) {
        ...
        uiModel.addAttribute("message", new Message("info", messageSource.getMessage("label_bill_amount", new Object[]{}, locale) + ": " + bill.getPriceAllOrders() + " " + messageSource.getMessage("label_currency", new Object[]{}, locale)));
