    ...
    b.extend(b.jgrid, {
        htmlDecode: function (d) {
            ...
            if (i && i !== null && i !== undefined) {
                ...
                c = g.y;
                if (c >= 70 && c <= 99)g.y = 1900 + g.y; else if (c >= 0 && c <= 69)g.y = 2E3 + g.y
            }
        ...
        randId: function (d) {
            ...
            if (typeof i === "function")return i(d);
            if (c && c[2])return c[1] ? b(c[1], d).attr(c[2]) : b(d).attr(c[2]); else {
                d = b(i, d);
                if (g)return d;
                return d.length >
                0 ? b(d).text() : undefined
            }
        }, ajaxOptions: {}, from: function (d) {
        ...
        return this.each(function () {
            if (!this.grid) {
                var c = b.extend(true, {
                    ...
                    headers: [], cols: [], footers: [], dragStart: function (e, f, j) {
                        ...
                        if (e) {
                            ...
                            if (m) {
                                ...
                                if (u)if (!(c.lastpage && z > c.lastpage || c.lastpage == 1 || z === c.page && z === c.lastpage))if (h.hDiv.loading)h.timer = setTimeout(h.populateVisible, c.scrollTimeout); else {
                                    c.page = z;
                                    if (w) {
                ...
                if (this.tagName.toUpperCase() != "TABLE")alert("Element is not a table"); else {
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length)alert(b.jgrid.errors.model);
                        ...
                        this.id);
                        x = y && b.browser.version <= 6 ? '<iframe style="display:block;position:absolute;z-index:-1;fetch:Alpha(Opacity=\'0\');" src="javascript:false;"></iframe>' : "";
                        ...
                        var M = function (e, f) {
                            ...
                            if (f === 0)z += "width: " + h.headers[e].width + "px;"; else if (s.cellattr && b.isFunction(s.cellattr))if ((e = s.cellattr.call(a, p, j, m, s, C)) && typeof e === "string") {
                            ...
                            function (e, f, j, m, p) {
                                ...
                                if (typeof C.formatter !== "undefined") {
                                    e = {rowId: e, colModel: C, gid: a.p.id, pos: j};
                            ...
                            if (f && a.p.scroll) {
                                b(">div:first", e).css({height: "auto"}).children("div:first").css({
                                    height: 0,
                                    display: "none"
                                });
                                e.scrollTop = 0
                            ...
                            if (b.isArray(a.p.data)) {
                                ...
                                if (a.p.treeGrid)b(a).jqGrid("SortTree", f, a.p.sortorder, m[f].stype, m[f].srcfmt); else {
                                    var w = {
                                        eq: function (v) {
                                            return v.equals
                                        }, ne: function (v) {
                        ...
                        x = function (e, f) {
                            ...
                            if (a.p.pgbuttons === true) {
                                ...
                                b("#first" + b.jgrid.jqID(f) + ", #prev" + b.jgrid.jqID(f) + ", #next" + b.jgrid.jqID(f) + ", #last" + b.jgrid.jqID(f)).click(function () {
                                    ...
                                    if (r === 0 || r === 1)L = K = S = O = false; else if (r > 1 && w >= 1)if (w === 1)S = O = false; else {
                                        if (w === r)L = K = false
                                    } else if (r > 1 && w === 0) {
                                        L = K = false;
                                        w = r - 1
                        ...
                        var Ea = function (e, f, j, m) {
                            if (a.p.colModel[f].sortable)if (!(a.p.savedRow.length > 0)) {
                                if (!j) {
                                    if (a.p.lastsort == f)if (a.p.sortorder == "asc")a.p.sortorder = "desc"; else {
                        ...
                        if (this.p.rownumbers) {
                            ...
                            this.p.colModel.unshift({
                                name: "rn", width: a.p.rownumWidth, sortable: false,
                        ...
                        b(a).before(h.hDiv).click(function (e) {
                            ...
                            if (j === true) {
                                if (a.p.cellEdit === true)if (a.p.multiselect && f)b(a).jqGrid("setSelection", Q[0].id, true); else {
                                    la = Q[0].rowIndex;
                                ...
                                } else if (a.p.multikey)if (e[a.p.multikey])b(a).jqGrid("setSelection", Q[0].id, true); else {
                        ...
                        b(h.bDiv).append(b('<div style="position:relative;' + (y && b.browser.version < 8 ? "height:0.01%;" : "") + '"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({
                            height: a.p.height + (isNaN(a.p.height) ? "" : "px"), width: h.width +
                            "px"
                        }).scroll(h.scrollGrid);
                        ...
                        a.updatepager = function (e, f) {
                            ...
                            if (u) {
                                ...
                                if (a.p.viewrecords)if (a.p.reccount === 0)b(".ui-paging-info", u).html(a.p.emptyrecords); else {
                                    C = p + 1;
                                    A = a.p.records;
                                    if (b.fmatter) {
        ...
        getGridParam: function (d) {
            ...
            return this.each(function () {
                function g(x) {
                    ...
                    if (I + x >= y + E)b(c.grid.bDiv)[0].scrollTop = I - (y + E) + x + E; else if (I < y + E)if (I < E)b(c.grid.bDiv)[0].scrollTop = I
                }
            ...
            if (i) {
                ...
                this.each(function () {
                    ...
                    if (!N)if (typeof d != "undefined")d += ""; else {
                        d = b.jgrid.randId();
...
(function (b) {
    ...
    b.fmatter.util = {
        NumberFormat: function (a, c) {
            ...
            if (!isNaN(c - 0) && String(a).toLowerCase() == "u")i = new Date(parseFloat(c) * 1E3); else if (c.constructor === Date)i = c; else if (e !== null) {
    ...
    b.unformat = function (a, c, d, f) {
        ...
        if (typeof j !== "undefined" && b.isFunction(j))g = j(b(a).text(), c, a); else if (!b.fmatter.isUndefined(e) && b.fmatter.isString(e)) {
            g = b.jgrid.formatter || {};
            switch (e) {
                case "integer":
        ...
        getColProp: function (b) {
            ...
            return this.each(function () {
                ...
                if (!this.ftoolbar) {
                        ...
                        if (this.search)switch (this.stype) {
                            case "select":
                                if (i =
                                    ...
                                    url: i, dataType: "html", success: function (o) {
                                    ...
                                    var m;
                                    if (d.searchoptions && d.searchoptions.value)m = d.searchoptions.value; else if (d.editoptions && d.editoptions.value)m = d.editoptions.value;
                                    if (m) {
                    ...
                    this.clearToolbar = function (d) {
                        ...
                        o || d && a(c).jqGrid("setGridParam", {search: m}).trigger("reloadGrid",
                            [{page: 1}]);
            ...
            return this.each(function () {
                ...
                var r, v = function (s, u) {
                    for (var w = 0, x = u.length; w < x; w++)if (u[w].startColumnName === s)return w;
                    return -1
                };
                a(e).prepend(p);
                ...
                for (c = 0; c < m; c++) {
                    ...
                    if (d >= 0) {
                        ...
                        d = a("<th>").attr({role: "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + e.p.direction).css({
                            height: "22px",
                            "border-top": "0px none"
                        }).html(f);
    ...
    a.extend(a.jgrid, {
        showModal: function (b) {
            ...
            a(e).css(a.extend({
                ...
                zIndex: d.zIndex,
                overflow: "hidden"
            }, c)).attr({tabIndex: "-1", role: "dialog", "aria-labelledby": b.modalhead, "aria-hidden": "true"});
            ...
            if (a.fn.jqm && c.jqm === true)c.jqM ? a(b).attr("aria-hidden", "false").jqm(c).jqmShow() : a(b).attr("aria-hidden", "false").jqmShow(); else {
                if (c.gbox !== "") {
        ...
        searchGrid: function (f) {
            ...
            return this.each(function () {
                ...
                if (e.grid) {
                    ...
                    if (a("#" + G.themodal).html() !== null)b(); else {
                        ...
                        if (!B && i || f.multipleSearch === false) {
                            ...
                            if (H >= 0 && s[H].searchoptions &&
                                s[H].searchoptions.sopt)J = s[H].searchoptions.sopt[0]; else if (f.sopt && f.sopt.length)J = f.sopt[0];
            ...
            return this.each(function () {
                    ...
                    a("#" + i + " > tbody > tr > td > .FormElement").each(function () {
                        ...
                        if (g.length) {
                            ...
                            switch (a(this).get(0).type) {
                                case "checkbox":
                                    if (a(this).is(":checked"))h[this.name] = a(this).val(); else {
                ...
                function q(g, k, v, p) {
                    ...
                    a(k.p.colModel).each(function (S) {
                        ...
                        if (E !== "cb" && E !== "subgrid" && this.editable === true && E !== "rn") {
                            if (I === false)r = ""; else if (E == k.p.ExpandColumn && k.p.treeGrid === true)r = a("td:eq(" + S + ")", k.rows[I]).text(); else {
                                try {
                                    r = a.unformat(a("td:eq(" +
                                    S + ")", k.rows[I]), {rowId: g, colModel: this}, S)
                                } catch (ea) {
                ...
                function B() {
                    ...
                    if (k[0] && !d[c.p.id].processing) {
                        ...
                        if (h[D] != p.addoper)h[E] = h[c.p.id + "_id"]; else if (h[E] === undefined)h[E] = h[c.p.id + "_id"];
                        delete h[c.p.id + "_id"];
                                ...
                                if (k[0] === false) {
                                    ...
                                    if (h[D] == p.addoper) {
                                        ...
                                        if (d[c.p.id].closeAfterAdd) {
                                            ...
                                            else if (c.p.treeGrid === true)a(c).jqGrid("addChildNode", k[2], L, h); else {
                ...
                if (c.grid && f) {
                    var t = c.p.id, o = "FrmGrid_" + t, i = "TblGrid_" + t, m = {
                        themodal: "editmod" +
                        t, modalhead: "edithd" + t, modalcontent: "editcnt" + t, scrollelm: o
                    ...
                    if (a("#" + m.themodal).html() !== null) {
                        ...
                        a.jgrid.viewModal("#" + m.themodal, {
                            gbox: "#gbox_" +
                            t, jqm: b.jqModal, jqM: false, overlay: b.overlay, modal: b.modal
                        });
                        ...
                        if (d[c.p.id].checkOnSubmit || d[c.p.id].checkOnUpdate) {
                            ...
                            K + ";display:none;'>&#160;" + (a.browser.msie && a.browser.version == 6 ? '<iframe style="display:block;position:absolute;z-index:-1;fetch:Alpha(Opacity=\'0\');" src="javascript:false;"></iframe>' : "") + "</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:" + (K + 1) + "'>" + b.saveData + "<br/><br/>" + $ + W + Z + "</div>").insertAfter("#" + o);
                        ...
                        a("#sData", "#" + i + "_2").click(function () {
                            ...
                            a("#FormError", "#" + i).hide();
                            e();
                            if (h[c.p.id + "_id"] == "_empty")B(); else if (b.checkOnSubmit === true) {
                                N = a.extend({}, h, O);
                                if (U = w(N, d[c.p.id]._savedData)) {
                                    a("#" + o).data("disabled", true);
                                    a(".confirm", "#" + m.themodal).show()
                ...
                function q(l, y, h, O) {
                    ...
                    a(y.p.colModel).each(function (L) {
                        ...
                        if (N !== "cb" && N !== "subgrid" && N !== "rn" && D) {
                            ...
                            var r = a.extend({}, {rowabove: false, rowcontent: ""}, this.formoptions ||
                ...
                if (e.grid)if (f) {
                    ...
                    if (a("#" + o.themodal).html() !== null) {
                                    ...
                                    complete: function (u, C) {
                                        ...
                                        if (m[0] === false) {
                                            ...
                                            if (d[e.p.id].reloadAfterSubmit && e.p.datatype != "local")a(e).trigger("reloadGrid"); else {
                                                ...
                                                } else for (var y = 0; y < A.length; y++)a(e).jqGrid("delRowData", e.p.idPrefix + A[y]);
                                                e.p.selrow = null;
                                                e.p.selarrrow = []
                                            }
                        ...
                        a("#eData", "#" + j + "_2").click(function () {
                            a.jgrid.hideModal("#" +
                            o.themodal, {gb: "#gbox_" + B, jqm: d[e.p.id].jqModal, onClose: d[e.p.id].onClose});
                            return false
                        });
                        q && d[e.p.id].beforeShowForm(a("#" + j));
                        a.jgrid.viewModal("#" + o.themodal, {
                        ...
                        for (var M = 0; M < s; M++) {
                            ...
                            if (b.edit) {
                                ...
                                a(j, c).attr({title: b.edittitle || "", id: e.id || "edit_" + o}).click(function () {
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        var i =
                                            n.p.selrow;
                                        if (i)a.isFunction(b.editfunc) ? b.editfunc(i) : a(n).jqGrid("editGridRow", i, e); else {
                            ...
                            if (b.view) {
                                ...
                                a(j, c).attr({title: b.viewtitle || "", id: B.id || "view_" + o}).click(function () {
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        var i = n.p.selrow;
                                        if (i)a.isFunction(b.viewfunc) ? b.viewfunc(i) : a(n).jqGrid("viewGridRow", i, B); else {
                                            a.jgrid.viewModal("#" + w.themodal, {gbox: "#gbox_" + n.p.id, jqm: true});
                                            a("#jqg_alrt").focus()
                                        }
                                    }
                            ...
                            if (b.del) {
                                ...
                                a(j, c).attr({title: b.deltitle || "", id: x.id || "del_" + o}).click(function () {
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        ...
                                        if (i)"function" == typeof b.delfunc ? b.delfunc(i) : a(n).jqGrid("delGridRow", i, x); else {
        ...
        return this.each(function () {
            if (!this.filter) {
                ...
                if (this.p.filter === null || this.p.filter ===
                    undefined)this.p.filter = {groupOp: this.p.groupOps[0].op, rules: [], groups: []};
                ...
                if (x) {
                    for (q = 0; q < x; q++) {
                        ...
                        if (j.sorttype)j.searchtype = j.sorttype; else if (!j.searchtype)j.searchtype =
                            "string";
                    ...
                    var z = function (d, g) {
                        ...
                        if (c.isFunction(g.searchrules))a =
                            g.searchrules(d, g); else if (c.jgrid && c.jgrid.checkValues)try {
...
(function (a) {
    ...
    a.jgrid.extend({
        editRow: function (c, d, b, h, l, n, s, o, f) {
            ...
            if (a.jgrid.realType(g[0]) === "Object")m = g[0]; else {
                ...
                if (i.grid) {
                    ...
                    if (r !== false)if ((a(r).attr("editable") || "0") == "0" && !a(r).hasClass("not-editable-row")) {
                        ...
                        a('td[role="gridcell"]', r).each(function (k) {
                            ...
                            if (z)q = a("span:first",
                                this).html(); else try {
                                q = a.unformat(this, {rowId: c, colModel: j[k]}, k)
                            } catch (A) {
                            ...
                            if (e != "cb" && e != "subgrid" && e != "rn") {
                                ...
                                if (j[k].editable === true) {
                                    ...
                                    var p = a.extend({}, j[k].editoptions || {}, {id: c + "_" + e, name: e});
            ...
            if (a.jgrid.realType(o[0]) === "Object")f = o[0]; else {
            ...
            if (o === "1") {
                ...
                if (v[0] === false) {
                    try {
                        ...
                        a.jgrid.info_dialog(a.jgrid.errors.errcap, v[1], a.jgrid.edit.bClose, {left: k[0], top: k[1]})
                    } catch (z) {
                        alert(v[1])
                    }
                    return m
                        ...
                        error: function (p, t) {
                            ...
                            if (a.isFunction(f.errorfunc))f.errorfunc.call(g, c, p, t); else try {
                                a.jgrid.info_dialog(a.jgrid.errors.errcap,
                                    '<div class="ui-state-error">' + p.responseText + "</div>", a.jgrid.edit.bClose, {buttonalign: "right"})
                            } catch (u) {
            ...
            if (a.jgrid.realType(b[0]) === "Object")h = b[0]; else if (a.isFunction(d))h.afterrestorefunc = d;
            ...
            return this.each(function () {
                function d(g, i, k) {
                    ...
                    if (k == "h") {
                        ...
                        if (a.rows[g].cells[i].offsetLeft + a.rows[g].cells[i].clientWidth >= k + parseInt(j, 10))b(a.grid.bDiv)[0].scrollLeft = b(a.grid.bDiv)[0].scrollLeft + a.rows[g].cells[i].clientWidth; else if (m < j)b(a.grid.bDiv)[0].scrollLeft = b(a.grid.bDiv)[0].scrollLeft - a.rows[g].cells[i].clientWidth
                    }
                }
                ...
                if (!(!a.grid || a.p.cellEdit !== true)) {
                    ...
                    b("#" + a.p.knv).focus().keydown(function (g) {
                        e = g.keyCode;
                        if (a.p.direction == "rtl")if (e == 37)e = 39; else if (e == 39)e = 37;
                        switch (e) {
                            case 38:
                                if (a.p.iRow - 1 > 0) {
                        ...
                        b("td", this).each(function (g) {
                            ...
                            if (c !== "cb" && c !== "subgrid")if (d == "dirty") {
                                if (b(this).hasClass("dirty-cell"))try {
                                    e[c] = b.unformat(this, {rowId: a.rows[h].id, colModel: a.p.colModel[g]},
                                        g)
                                } catch (i) {
    ...
    e.jgrid.extend({
        groupingSetup: function () {
            ...
            this.each(function () {
                ...
                if (b.hasOwnProperty(g))b[g].push(a); else {
                    b[g] = [];
                    b[g].push(a);
            ...
            return this.each(function () {
                ...
                if (a.p.treeGrid) {
                    ...
                    if (a.p.treeGridModel == "nested")a.p.treeReader = d.extend({
                        ...
                        loaded: "loaded",
                        icon_field: "icon"
                    }, a.p.treeReader); else if (a.p.treeGridModel == "adjacency")a.p.treeReader = d.extend({
                        level_field: "level",
    ...
    xml2json: function (a, b) {
        ...
        var h = function (d, c, i) {
                ...
                if (d instanceof Array)if (d.length === 0)g += i + "<" + c + ">__EMPTY_ARRAY_</" + c + ">\n"; else {
                    ...
                    for (j in d)if (d.hasOwnProperty(j))if (j.charAt(0) ===
                        "@")g += " " + j.substr(1) + '="' + d[j].toString() + '"'; else k = true;
                    g += k ? ">" : "/>";
                    if (k) {
                        for (j in d)if (d.hasOwnProperty(j))if (j === "#text")g += d[j]; else if (j === "#cdata")g += "<![CDATA[" + d[j] + "]]\>"; else if (j.charAt(0) !== "@")g += h(d[j], j, i + "\t");
                        g += (g.charAt(g.length - 1) === "\n" ? i : "") + "</" + c + ">"
                    }
                } else if (typeof d === "function")g += i + "<" + c + "><![CDATA[" + d + "]]\></" + c + ">"; else {
                    if (d === undefined)d = "";
        ...
        if (a.nodeType === 1) {
            ...
            if (a.firstChild) {
                ...
                else b = this.escape(this.innerXml(a)); else if (e)if (a.attributes.length)b["#text"] = this.escape(this.innerXml(a)); else {
    ...
    a.jgrid.extend({
        sortableColumns: function (b) {
            ...
            if (!a("#colchooser_" + c[0].p.id).length) {
                ...
                b = a.extend({
                    width: 420,
                    height: 240, classname: null, done: function (d) {
            ...
            return this.each(function () {
                ...
                if (c.grid)if (!c.p.treeGrid)if (a.fn.draggable && a.fn.droppable) {
                    ...
                    if (typeof b == "string" && b == "updateDnD" && c.p.jqgdnd === true)h(); else {
                        b = a.extend({
                            drag: function (e) {
                                return a.extend({
                                    start: function (g, j) {
